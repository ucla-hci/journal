...
openRequest.addEventListener("upgradeneeded", (e) => {
  ...
  dataTable = inDB.createObjectStore("data", {
    keyPath: "id",
    autoIncrement: false,
  }); // Table header
  markTable = inDB.createObjectStore("mark", {
    keyPath: "id",
    autoIncrement: false,
  });
});
...
Check more prompts from (http://exw.utpsyc.org/index.php](http://exw.utpsyc.org/index.php)`;
  ...
  let dataOne = {
    ...
    marks: [
      ...
      { tag: "pause-hl 1", from: { line: 0, ch: 80 }, to: { line: 0, ch: 87 } },
      {
        tag: "fluent-hl 2",
        from: { line: 0, ch: 326 },
        to: { line: 0, ch: 596 },
  ...
  let markOne = {
    ...
    commentLog: {
      1: {
        tag: "others",
        comment:
          'As a good friend of myself, I will say to myself, "wow! it is so glad to hear that you feel better than before',
      },
      2: {
        content: "I can't",
        tag: "pause",
        comment:
          "I think I have a lot of uncertainties in my mind, kind of a mess, mixing together, which hindered me from describing them.",
        from: { line: 0, ch: 80, sticky: "after", xRel: 3.387451171875 },
        to: { line: 0, ch: 87, sticky: "before", xRel: -3.8250732421875 },
      },
      3: {
        content:
          "I have tons of things to do every day. Did these make me feel happy? Now, one year later, or ten years later? Why do I spend my effort and time on them? I don't have an answer in my mind now. Before I figure it out, I just want to slow down a little bit and keep going. ",
        tag: "fluent",
        comment:
          'I wrote very fluently here. I was just pouring out all the questions that bothered me in my mind. Instead of saying that "I don\'t have an answer", I hope someone or some guidance can help me to check these "tons of things" one by one.',
        from: { line: 0, ch: 326, sticky: "before", xRel: -0.57501220703125 },
        to: { line: 0, ch: 596, sticky: "before", xRel: -2.6875 },
      },
      4: {
        tag: "others",
        comment:
          "Am I thinking in absolutes? I guess no one can totally recover from one traumatic event very quickly. I need to give myself more time.",
      },
      5: {
        content:
          "But one morning, we both had great pressure on pushing forward the progress. When I pointed out that one more modification should be done as soon as possible, he suddenly went mad, shouted at me and threw the device into the table, making a huge sound. I was scared, but I found myself still pretending to be calm enough to deal with the situation. I just walked away in case he would have more behaviors out of control. ",
        tag: "fluent",
        comment:
          "I wrote fluently here because I remember every detail very clearly. I can still feel the strong emotion I had at that moment and it was hurt.",
        from: { line: 2, ch: 309, sticky: "after", xRel: 3.3499755859375 },
        to: { line: 2, ch: 730, sticky: "before", xRel: -0.2750244140625 },
      },
      6: {
        content: "Before this event,",
        tag: "pause",
        comment:
          "I paused for a long long time here and felt really sad. I know collaboration is very important and I should not hold this kind of attitude towards it.",
        from: { line: 2, ch: 111, sticky: "before", xRel: -0.9000244140625 },
        to: { line: 2, ch: 129, sticky: "before", xRel: -2.7125244140625 },
      },
      7: {
        tag: "others",
        comment:
          'If I can send this writing to one therapist, I hope the therapist can help me dig out this "something".',
      },
      8: {
        tag: "others",
        comment:
          "I really don't know what to say to comfort you, just a warm hug. And you always have the choice to recover from it. Take it easy!",
      },
    },
    commentSet: [
      'As a good friend of myself, I will say to myself, "wow! it is so glad to hear that you feel better than before',
...
function generatePackTwo(_returnPack) {
  ...
  request.onsuccess = function (event) {
    ...
    if (cursor) {
      ...
      if (!(id === 0 || id === "0")) {
        let mark = {
          commentLog: cursor.value.commentLog,
          commentSet: cursor.value.commentSet,
          tagCount: cursor.value.tagCount,
        };
        if (returnPack[id]) {
...
let myDict = [
  ...
  },
  {
    ...
    wordnet_ext: [],
    phrase_ext: [],
    reprogramming: ["-> can/choose/want to/prefer/would like to/plan to"],
  },
  {
    strategy_code: "L2b",
    category_number: 2,
  ...
  },
  {
    ...
    wordnet_ext: [],
    phrase_ext: [],
    reprogramming: ["I am having the thought of + [ ]"],
  },
  {
    strategy_code: "L2d",
    category_number: 1,
    ...
    phrase_ext: [],
    reprogramming: ["L2d: No Reprogramming"],
  },
  {
    strategy_code: "L2d",
    category_number: 1,
  ...
  },
  {
    ...
    phrase_ext: [
      "what is the point, there is no point, worth nothing, not worthing anything",
    ],
    reprogramming: [],
  },
  {
    ...
    phrase_ext: ["loss of interest, lost/lose interest, used to + interest*"],
    reprogramming: [],
  },
  {
    strategy_code: "L2d",
  ...
  },
  {
    ...
    phrase_ext: [
      "can't sleep, sleep less",
      "sleep + long/ too much, hard + wake up",
    ],
    reprogramming: [],
  },
  {
  ...
  },
  {
    ...
    words: ["distract"],
    wordnet_ext: ["perturb, unhinge, disquiet, trouble, cark, disorder "],
  ...
  },
  {
    ...
    phrase_ext: ["end my life", "kill myself"],
    reprogramming: [],
  },
  {
    strategy_code: "L2e",
  ...
  },
  {
    ...
    wordnet_ext: [],
    phrase_ext: [],
    reprogramming: ["L2f No Reprogramming"],
  },
  {
    strategy_code: "L2f",
    category_number: 2,
